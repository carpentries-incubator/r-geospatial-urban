...
In the following parts of this workshop, you will use this package to visualize geospatial data. First, lets plot the distribution of life expectancy in the `gapminder` dataset:
