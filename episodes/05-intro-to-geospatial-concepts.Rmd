...
```{r fig-vector-raster, fig.cap="Overview of vector and raster data: definitions, subtypes, examples and common file formats (Image by Daniele Cannatella).", echo=FALSE}
