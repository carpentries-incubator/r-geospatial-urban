...
```{r fig-vector-raster-1, fig.cap="Same geographical area as raster and vector data (Source: Saab, 2003)", echo=FALSE}
...
```{r fig-vector-raster-2, fig.cap="Overview of vector and raster data: definitions, subtypes, examples and common file formats (Image by Daniele Cannatella).", echo=FALSE}
