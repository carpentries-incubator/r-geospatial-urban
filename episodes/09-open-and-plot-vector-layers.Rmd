...
1. it makes the interaction with or translation to/from software using the simple features standard like PostGIS easy, and  
2. it allows for easy autocompletion of function names in RStudio.
