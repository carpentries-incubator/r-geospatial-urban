...
For this episode, we will be working with the Digital Terrain Model (DTM) data. This differs from the surface model data we’ve been working with so far in that the digital surface model (DSM) includes the tops of trees and buildings, while the DTM shows the ground level.
=======
...
>>>>>>> 963dd67 (Update raster episodes)
