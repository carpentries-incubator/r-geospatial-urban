...
across other data structures such as lists, data frames and matrices as well.
For an overview, see [Data Types and Structures](https://swcarpentry.github.io/r-novice-inflammation/13-supp-data-structures.html).
...
actually treated as numbers by `R`. 
