...
Failed to connect to overpass.kumi.systems port 443 after 8003 ms: Couldn't connect to server
```
...
Caused by error in `curl::curl_fetch_memory()`:
! Couldn't connect to server [overpass.kumi.systems]:
Failed to connect to overpass.kumi.systems port 443 after 0 ms: Couldn't connect to server
```
