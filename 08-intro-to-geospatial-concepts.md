...
<div class="figure" style="text-align: center">
<img src="fig/vector-raster-1.png" alt="Same geographical area as raster and vector data (Source: ???)" width="419" />
<p class="caption">Same geographical area as raster and vector data (Source: ???)</p>
</div>
