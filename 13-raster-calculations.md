...
We often want to combine values of and perform calculations on rasters to create a new output raster. This episode covers how to subtract one raster from another using basic raster math. Raster calculations are a core part of spatial analysis because they allow us to combine, transform, and derive new information from existing raster layers. By applying mathematical operations cell-by-cell, we can create entirely new datasets that reveal spatial patterns and relationships.

For example, in environmental analysis, we can combine rainfall and temperature rasters to identify areas that are more suitable for agriculture or more vulnerable to drought. Similarly, in urban planning, land surface temperature rasters can be combined with vegetation cover data to detect urban heat island hotspots.
...
<img src="fig/13-raster-calculations-rendered-plot-dtm-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/13-raster-calculations-rendered-plot-dsm-1.png" alt="" style="display: block; margin: auto;" />

## Raster math and Canopy Height Models

We can perform raster calculations by subtracting (or adding, multiplying, etc.) two rasters. In the geospatial world, we call this “![Map Algebra](https://en.wikipedia.org/wiki/Map_algebra)”.
...
<img src="fig/13-raster-calculations-rendered-plot-chm-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/13-raster-calculations-rendered-chm-hist-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/13-raster-calculations-rendered-chm-challenge-1.png" alt="" style="display: block; margin: auto;" />
...
<img src="fig/13-raster-calculations-rendered-chm-challenge-2.png" alt="" style="display: block; margin: auto;" />
